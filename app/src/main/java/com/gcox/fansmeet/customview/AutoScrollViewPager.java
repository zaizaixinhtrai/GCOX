...
public class AutoScrollViewPager extends ViewPager {
    ...
    private void init() {
        ...
        initSpeedOfTransition();
    }
    /*
   * Override the Scroller instance with our own class so we can change the
   * duration
   */
    private void initSpeedOfTransition() {
        try {
...
//                isStopByTouch = true;
//                stopAutoScroll();
////                LogUtils.logE("AutoScrollViewPager", "stopAutoScroll");
////                LogUtils.logE("AutoScrollViewPager", "downY " + downY);
//            } else if (ev.getAction() == MotionEvent.ACTION_UP && isStopByTouch) {
//                startAutoScroll();
////                LogUtils.logE("AutoScrollViewPager", "startAutoScroll");
//            }
//        }
...
////            LogUtils.logE("AutoScrollViewPager","deltaY " + Math.abs(deltaY));
////            LogUtils.logE("AutoScrollViewPager","deltaX " + Math.abs(deltaX));
