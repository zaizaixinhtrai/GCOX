package com.gcox.fansmeet.customview.ScalableVideo;
...
public class ScalableVideoView extends TextureView implements TextureView.SurfaceTextureListener,
    ...
    private void scaleVideoSize(int videoWidth, int videoHeight) {
        Timber.e("videoWidth:" + videoWidth);
        Timber.e("videoHeight:" + videoHeight);

        Timber.e("viewSizeWidth:" + getWidth());
        Timber.e("viewSizeHeight" + getHeight());
