...
public class VideoControllerView extends FrameLayout {
    ...
    private void initControllerView(View v) {
        ...
        mProgress.setPadding(PixelUtil.dpToPx(mContext, 7), 0, PixelUtil.dpToPx(mContext, 5), 0);
        if (mProgress != null) {
    ...
    public void updatePausePlay() {
        ...
        if (mPlayer.isPlaying()) {
            mPauseButton.setImageResource(R.drawable.icon_recvid_pause);
        } else {
            mPauseButton.setImageResource(R.drawable.icon_recvid_play);
        }
    }
