...
class BezierView extends RelativeLayout {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if(!isLinear){
             ...
             */
            path.cubicTo(bezierWidth / 4, bezierHeight, bezierWidth / 4, 2, bezierWidth / 2, 2);
            /**
             * Seth second part of bezier view
             */
            path.cubicTo((bezierWidth / 4) * 3, 2, (bezierWidth / 4) * 3, bezierHeight, bezierWidth, bezierHeight);
        }
    ...
    void build(int bezierWidth, int bezierHeight,boolean isLinear) {
        ...
        this.bezierHeight = bezierHeight*3;
