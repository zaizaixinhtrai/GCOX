 ...
 */
class FollowUseCase constructor(uiThread: Scheduler, executorThread: Scheduler, private val dataRepository: UserActionRepository)
    ...
    override fun buildObservable(followUserId: Int): Observable<FollowUserModel> {
        return dataRepository.followUser(followUserId)
    }
