...
public class VideoRangeSeekBar extends View {
    ...
    protected float MAX_RANGE = 15.0f;
    protected float MIN_RANGE = 3.0f;
    // 0.0 ~ 300.0
    ...
    public interface OnRangeBarChangeListener {
        ...
        void onIndexChangeListener(VideoRangeSeekBar rangeBar, float rangeStart, float rangeEnd,
    ...
    public interface OnVideoMaskScrollListener {
        void onVideoMaskScrollListener(VideoRangeSeekBar rangeBar, MotionEvent event);
    }
}
