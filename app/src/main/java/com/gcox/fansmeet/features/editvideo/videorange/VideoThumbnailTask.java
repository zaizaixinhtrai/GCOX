...
import com.gcox.fansmeet.features.editvideo.BeLiveEditKit;
...
//            return null;
//        }
        Bitmap bitmap = mRetriever.getVideoThumbnailAtTime(mMS, 0, 0,false);
        if (bitmap == null) {
