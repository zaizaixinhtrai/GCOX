...
public class DialogbeLiveConfirmation {
    ...
    public DialogbeLiveConfirmation(Builder builder) {
        ...
        colorInfluencers = builder.colorInfluencers;
    ...
    public void show(Context context) {
        ...
        LinearLayout parentOKButton = mDialog.findViewById(R.id.parentOKButton);
        ...
        if (colorInfluencers != null) {
            tvDialogTitle.setTextColor(Color.parseColor(colorInfluencers));
            btnOK.setBackgroundColor(Color.parseColor(colorInfluencers));
            LinearLayout.LayoutParams params = new LinearLayout.LayoutParams
                    (PixelUtil.dpToPx(mDialog.getContext(), 100), LinearLayout.LayoutParams.WRAP_CONTENT);
            params.weight = 0;
            btnOK.setLayoutParams(params);
            btnOK.setBackgroundResource(R.drawable.influencers_button_ok);
        }
    }
    ...
    public static final class Builder {
        ...
        private String colorInfluencers;
        ...
        public Builder setTextColorInfluencers(String colorInfluencers) {
            this.colorInfluencers = colorInfluencers;
            return this;
        }
